<div class="overflow-hidden bg-white py-24 sm:py-32">
  <div class="mx-auto max-w-2xl px-6 lg:max-w-7xl lg:px-8">
    <div class="max-w-4xl">
      ...
      <h1 class="mt-2 text-pretty text-4xl font-semibold tracking-tight text-gray-900 sm:text-5xl">О компании</h1>
      <p class="mt-6 text-balance text-xl/8 text-gray-700"><span class="font-semibold">Наша команда</span> оказывает профессиональные дизайнерские услуги
    ...
    <section class="mt-20 grid grid-cols-1 lg:grid-cols-2 lg:gap-x-8 lg:gap-y-16">
      <div class="lg:pr-8">
        <h2 class="text-pretty text-2xl font-semibold tracking-tight text-gray-900">Наша команда</h2>
        <p class="mt-6 text-base/7 text-gray-600">Оказываем профессиональные дизайнерские услуги
