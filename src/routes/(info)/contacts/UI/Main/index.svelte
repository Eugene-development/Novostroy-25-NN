<div class="isolate bg-white px-6 py-24 sm:py-32 lg:px-8">
	<div class="mx-auto max-w-3xl sm:text-center">
		...
		<p class="mt-2 text-lg/8 text-gray-600">
			Мы работаем с понедельника по субботу с 10 до 20 по московскому времени.
		</p>
	...
	<div class="mx-auto mt-20 max-w-xl space-y-16">
		<div class="flex gap-x-6">
			...
			<div>
				...
				<p class="mt-2 text-base/7 text-gray-600">
					Ut cursus est ut amet. Lobortis eget egestas leo vitae eget porttitor risus blandit. Nunc
					a in lorem vel iaculis porttitor.
				</p>
		...
		<div class="flex gap-x-6">
			...
			<div>
				...
				<p class="mt-2 text-base/7 text-gray-600">
					Sint aut modi porro consequatur architecto commodi qui consequatur. Dignissimos adipisci
					minima.
				</p>
				<div class="mt-4 text-sm/6 font-semibold">
