<div
	class="relative isolate overflow-hidden bg-white py-24 animate-fade animate-duration-500 animate-ease-in-out animate-delay-500 sm:py-32"
>
	<div
	...
	<div class="mx-auto max-w-7xl px-6 lg:px-8">
		<div class="mx-auto max-w-2xl lg:mx-0">
			...
			<p class="mt-10 max-w-xl text-lg/7 text-gray-700 lg:col-span-7">
				Мы стремимся к созданию долгосрочных и взаимовыгодных отношений с нашими партнёрами, чтобы
				вместе достигать новых высот и открывать новые возможности.
			</p>
		</div>
		<div
		...
		>
			...
			<div class="max-w-2xl text-lg/7 text-gray-700 lg:col-span-7">
				...
				<ul role="list" class="mt-8 max-w-xl space-y-8 text-gray-600">
					<li class="flex gap-x-3">
						...
						<span
							...
							сможем реализовать ваши идеи в дизайне интерьера.</span
						>
					</li>
					<li class="flex gap-x-3">
						<svg
						...
						<span
							...
							проведения ремонтных работ клиенты приобретают новую мебель.</span
						>
					</li>
					<li class="flex gap-x-3">
						<svg
				...
				<h2 class="mt-16 text-2xl font-bold tracking-tight text-gray-900">Вы мебельная фабрика?</h2>
				<p class="mt-6">
					Мы готовы предложить вам уникальные возможности для совместного развития и роста. Наши
					решения интернет маркетинга помогут вам привлечь новых клиентов.
				</p>
			</div>
		</div>
	</div>
