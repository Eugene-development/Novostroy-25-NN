    ...
    <div class="flex gap-3">
      ...
      <div class="text-sm/6">
        ...
        <div class="mt-5 sm:mt-6">
          <button type="button" onclick={() => (visibleCheckCity.value = false)} class="inline-flex w-full justify-center rounded-md bg-indigo-600 px-3 py-2 text-sm font-semibold text-white shadow-sm hover:bg-indigo-500 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-indigo-600">Подтвердить</button>
        </div>
      </div>
    </div>
  </div>
