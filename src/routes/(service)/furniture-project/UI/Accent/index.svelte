	...
	const incentives = [
		{
			...
			description: 'Удобство и комфорт в каждом модуле проектируемой мебели'
		},
		{
			name: 'Чертёж в проекции',
			imageSrc: 'https://tailwindui.com/img/ecommerce/icons/icon-warranty-simple.svg',
			description: 'Наглядная модель с детализацией размеров всех элементов проекта'
		},
		{
			name: 'Подбор фурнитуры',
			imageSrc: 'https://tailwindui.com/img/ecommerce/icons/icon-exchange-simple.svg',
			description: 'Оптимальный подбор комплектующих для лучшей функциональности'
		}
	];
</script>
