	...
	const incentives = [
		{
			...
			description: 'Мы сможем предложить практически любой материал, используемый в производстве.'
		},
		{
			name: 'Грузчики',
			imageSrc: 'https://tailwindui.com/img/ecommerce/icons/icon-warranty-simple.svg',
			description: 'Мы поможем определиться с цветовой гаммой подбираемых материалов.'
		},
		{
			name: 'Безопасно',
			imageSrc: 'https://tailwindui.com/img/ecommerce/icons/icon-exchange-simple.svg',
			description: 'Мы знаем ответ на самый важный вопрос кому доверить изготовление заказа.'
		}
	];
</script>
