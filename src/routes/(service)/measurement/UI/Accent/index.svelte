<script>
	const incentives = [
		{
			name: 'Лазерный инструмент',
			imageSrc: 'https://tailwindui.com/img/ecommerce/icons/icon-shipping-simple.svg',
			description: 'Точные измерения с помощью современного технического оборудования'
		},
		{
			name: 'Учёт углов',
			imageSrc: 'https://tailwindui.com/img/ecommerce/icons/icon-warranty-simple.svg',
			description: 'Полный анализ геометрии пространства с учётом углов и размерностей'
		},
		{
			name: 'Обозначение коммуникаций',
			imageSrc: 'https://tailwindui.com/img/ecommerce/icons/icon-exchange-simple.svg',
			description: 'Детальная фиксация сантехнических конструкций и электрических коммуникаций'
		}
	];
</script>
