...
<div class="relative animate-fade animate-duration-500 animate-ease-in-out">
	<div class="mx-auto max-w-7xl">
		<div class="relative z-10 pt-8 lg:w-full lg:max-w-3xl">
			...
			<div class="relative px-6 py-2 sm:py-24 lg:px-8 lg:py-32 lg:pr-0">
				<div class="mx-auto max-w-3xl lg:mx-0 lg:max-w-2xl">
					...
					<p class="mt-2 text-pretty text-base font-medium text-gray-500 sm:text-lg/8">
						Мечтаете о стильном и уютном доме? Мы разрабатываем уникальные проекты интерьеров,
						которые сочетают эстетичность и практичность.
					</p>
					<p class="mt-2 text-pretty text-base font-medium text-gray-500 sm:text-lg/8">
						Наш дизайнер подберёт цветовые решения, материалы, мебель и декор, чтобы ваше
						пространство стало отражением вашей индивидуальности.
					</p>
					<p class="mt-2 text-pretty text-base font-medium text-gray-500 sm:text-lg/8">
					...
					<div class="mt-12 flex items-center gap-x-6">
						<button
							onclick={() => (visibleDesignProjectForm.value = !visibleDesignProjectForm.value)}
							type="button"
