	...
	const incentives = [
		{
			...
			description: 'Квалифицированный монтаж с опытными обученными сотрудниками'
		},
		{
			name: 'Дополнительные работы',
			imageSrc: 'https://tailwindui.com/img/ecommerce/icons/icon-warranty-simple.svg',
			description: 'Широкий спектр сопутствующих дополнительных услуг при монтаже'
		},
		{
			name: 'Профессиональный инструмент',
			imageSrc: 'https://tailwindui.com/img/ecommerce/icons/icon-exchange-simple.svg',
			description: 'Качественные работы с использованием современного оборудования'
		}
	];
</script>
