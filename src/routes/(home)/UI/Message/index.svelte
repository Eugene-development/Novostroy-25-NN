<script>
	...
	const text =
		'Наша компания предлагает создание стильных дизайн-проектов корпусной мебели и интерьера с точным подбором бытовой техники, освещением, сантехники и кухонных столешниц.';
</script>
