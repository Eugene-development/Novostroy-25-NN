			...
			<div class="lg:col-end-1 lg:w-full lg:max-w-xl lg:pb-8">
				...
				<div class="mt-8 border-l border-sky-400 pl-6">
					<p class="mt-3 text-base/6  text-gray-600">
						Мы помогаем нашим клиентам сделать правильный выбор материалов, цвета материалов и производителя
						мебели. Это позволит значительно <span class="font-semibold text-sky-600"
					...
					<p class="mt-3 text-base/6  text-gray-600">
						...
						мойку со смесителем, чтобы создать функциональный и красивый дизайн.
					</p>
					<p class="mt-3 text-base/6  text-gray-600">
						Работая со шкафами и гардеробами мы организуем удобство и функциональность, продумывая эргономику,
