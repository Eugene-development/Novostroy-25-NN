	...
	<div class="mx-auto max-w-7xl px-4 lg:flex lg:px-4">
		...
		>
			<div class="lg:col-end-1 lg:w-full lg:max-w-xl lg:pb-8">
				...
				<p class="mt-3 text-lg/8 text-gray-600">
				...
				<p class="mt-3 text-lg/8 text-gray-600">
					К кухонным гарнитурам мы подбираем качественную фурнитуру, стильную столешницу, технику и мойку чтобы создать
				 функциональный и красивый дизайн.
				</p>
				<p class="mt-3 text-lg/8 text-gray-600">
					Работая со шкафами мы организуем удобство и функциональность, продумывая эргономику, необходимое освещение и системы хранения.
				</p>
			</div>
