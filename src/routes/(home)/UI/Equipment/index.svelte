				...
				>
					...
					<div class="p-7 pt-4">
						...
						<p class="mt-2 max-w-lg text-sm/6 text-gray-600">
							...
							производителей. Индивидуальный подбор материалов и цветов для создания гармоничного интерьера
						</p>
					</div>
				</div>
				<div
			...
			<div class="relative lg:col-span-3">
				...
				>
					...
					<div class="p-7 pt-4">
						...
						<p class="mt-2 max-w-lg text-sm/6 text-gray-600">
							Современные механизмы, обеспечивающие плавность, надежность и бесшумность в использовании. Широкий ассортимент для комфортного хранения и оптимальной организации пространства
						</p>
					</div>
				</div>
				<div
			...
			<div class="relative lg:col-span-2">
				...
				>
					...
					<div class="p-7 pt-4">
						...
						<p class="mt-2 max-w-lg text-sm/6 text-gray-600">
							Встраиваемая и отдельностоящая бытовая техника от проверенных производителей с
			...
			<div class="relative lg:col-span-2">
				...
				>
					...
					<div class="p-7 pt-4">
						...
						<p class="mt-2 max-w-lg text-sm/6 text-gray-600">
							Качественная сантехника для ванной и кухни от ведущих мировых и Российских
							производителей с гарантией до 5 лет
						</p>
					</div>
				</div>
				<div
			...
			<div class="relative lg:col-span-2">
				...
				>
					...
					<div class="p-7 pt-4">
						...
						<p class="mt-2 max-w-lg text-sm/6 text-gray-600">
							Комфортное освещение позволяет создать уютную атмосферу в каждом уголке вашего дома в любое время суток
						</p>
					</div>
				</div>
				<div
			...
			<div class="relative lg:row-span-2">
				<a href="/mebel">
					...
					>
						...
						<img
							class="mt-8 size-full object-cover object-top"
							src="https://zovofficial.com/image/cache/catalog/products/kuhni/2024/mari/cam-1-1087x890.jpg"
							alt=""
						/>
					</div>
					<div
			...
			<div class="relative lg:row-span-2">
				...
				>
					<a href="/tehnika">
						...
						<img
							class="mt-8 size-full object-cover object-top"
							src="https://storage.yandexcloud.net/mine2024/novostroy/catalog/qw5yl8ky74uqksdk65plp18s8wxa4ctn.jpg"
							alt=""
						/>
					</a>
				</div>
