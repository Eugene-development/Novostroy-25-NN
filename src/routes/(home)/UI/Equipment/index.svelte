				...
				>
					...
					<div class="p-7 pt-4">
						...
						<p class="mt-2 max-w-lg text-sm/6 text-gray-600">
							...
							производителей. Индивидуальный подбор материалов и цветов для создания гармоничного
							интерьера
						</p>
					</div>
				</div>
			...
			<div class="relative lg:col-span-3">
				...
				>
					...
					<div class="p-7 pt-4">
						...
						<p class="mt-2 max-w-lg text-sm/6 text-gray-600">
							Современные механизмы, обеспечивающие плавность, надежность и бесшумность в
							использовании. Широкий ассортимент для комфортного хранения и оптимальной организации
							пространства
						</p>
					</div>
				</div>
			...
			<div class="relative lg:col-span-2">
				...
				>
					...
					<div class="p-7 pt-4">
						...
						<p class="mt-2 max-w-lg text-sm/6 text-gray-600">
							Комфортное освещение позволяет создать уютную атмосферу в каждом уголке вашего дома в
							любое время суток
						</p>
					</div>
				</div>
