...
<div class="relative isolate overflow-hidden bg-gray-950 py-24 sm:py-32 ">
    ...
    <div class="mx-auto max-w-7xl px-6 lg:px-8">
      <div class="mx-auto max-w-3xl lg:mx-0">
        <h2 class="text-4xl md:text-7xl font-bold text-gray-50">
          Наша работа
        </h2>
        <p class="mx-auto mt-6 text-sm sm:text-lg leading-7 text-gray-300">
      ...
      <div  class="mx-auto mt-16 grid max-w-2xl grid-cols-1 gap-6 sm:mt-20 lg:mx-0 lg:max-w-none lg:grid-cols-3 lg:gap-8 ">
            ...
            <div  >
                    ...
                    <div class="flex gap-x-4 rounded-xl bg-white/5 p-6 ring-1 ring-inset ring-white/10">
                        <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width={1.5} stroke="currentColor" class="h-7 w-5 flex-none text-sky-400">
                        ...
                        <p class="text-sm mt-2 text-gray-300 text-pretty">
                            {card.description}
                        </p>
                        </div>
                    </div>
