		...
		<div class="mt-10 max-w-3xl">
			<ul role="list" class="mt-8 max-w-xl space-y-8 text-gray-600">
				<li class="flex gap-x-3">
					...
					<span
						><strong class="font-semibold text-gray-900">Data types.</strong> Lorem ipsum, dolor sit
				...
				<li class="flex gap-x-3">
					...
					<span
						><strong class="font-semibold text-gray-900">Loops.</strong> Anim aute id magna aliqua ad
				...
				<li class="flex gap-x-3">
					...
					<span
						><strong class="font-semibold text-gray-900">Events.</strong> Ac tincidunt sapien vehicula
			...
			<figure class="mt-10 border-l border-sky-600 pl-9">
