      ...
      <div class="lg:grid lg:grid-cols-2 lg:items-start lg:gap-x-8">
        ...
        <div class="flex flex-col-reverse">
            ...
            <div class="grid grid-cols-4 gap-6" aria-orientation="horizontal" role="tablist">
              <button id="tabs-1-tab-1" class="relative flex h-24 cursor-pointer items-center justify-center rounded-md bg-white text-sm font-medium uppercase text-gray-900 hover:bg-gray-50 focus:outline-none focus:ring focus:ring-indigo-500/50 focus:ring-offset-4" aria-controls="tabs-1-panel-1" role="tab" type="button">
                ...
                <span class="absolute inset-0 overflow-hidden rounded-md">
                  <img src={`${import.meta.env.VITE_S3}/catalog/${data.image[0].hash}`} alt="" class="size-full object-contain">
                </span>
          ...
          <div >
            ...
            <div id="tabs-1-panel-1" aria-labelledby="tabs-1-tab-1" role="tabpanel" tabindex="0" class="cursor-pointer w-full aspect-w-15 aspect-h-10 scale110">
              <img src={`${import.meta.env.VITE_S3}/catalog/${data.image[0].hash}`} alt="Angled front view with bag zipped and handles upright." class=" w-full object-contain sm:rounded-lg">
            </div>
        ...
        <div class="mt-10 px-4 sm:mt-16  lg:mt-0">
          ...
          <div class="mt-3">
            ...
            <a href="/{data.parentable.parentable.parentable.slug}/{data.parentable.parentable.slug}/{data.parentable.slug}" class="text-xl tracking-tight text-gray-900">{data.parentable.value}</a>
          </div>
          ...
          <div class="mt-6">
            ...
            <div class="space-y-6 text-base text-gray-700">
                <p>Наш дизайнер бесплатно даст вам общую консультацию по интересующим вас вопросам, связанным с проектированием мебели и условиям нашей работы.</p>
            	<p>Мы дадим советы по выбору материалов и цветов и составим для вас стартовый дизайн-проект.</p>
			</div>
          </div>
